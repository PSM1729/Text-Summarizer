...
#Buttons
button1=Button(tab1,text="Reset", width=12,bg='#03A9F4',fg='#000')
...
#Summary TextBox
tab1_display = Text(tab1,height=19, width=95).place(x=10, y=350)
...
b0=Button(tab2,text="Open File", width=12,bg='#c5cae9')
b0.grid(row=3,column=0,padx=10,pady=10)

b1=Button(tab2,text="Reset ", width=12,bg="#b9f6ca")
